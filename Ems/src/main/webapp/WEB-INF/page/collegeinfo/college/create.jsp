...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">新建学院</div>
				<div class="panel-body">
					<form role="form" id="collegeCreateForm"
						class="form-horizontal"
						action="${pageContext.request.contextPath}/collegeinfo/college/create"
						method="post" >
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input class="form-control" placeholder="请输入学院名" name="name">
							</div>
						</div>
	...
	<script type="text/javascript">
   	    	...
   	    	fields['id'].validators['notEmpty'] = {
   	  		...
   	  		// 将验证规则应用到表单的字段中
   			$('#collegeCreateForm').bootstrapValidator({
	            // 默认错误消息
   				message: '输入值不合法',
   				// 设置验证成功或者失败的图标
	            feedbackIcons: {
   	    	...
   	    	// 关联对象选择器按钮点击事件
   	    	$('#collegeCreateForm .input-group-btn').click (function () {
