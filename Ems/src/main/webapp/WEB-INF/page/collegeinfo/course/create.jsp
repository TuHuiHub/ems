...
<div id="page-wrapper">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form role="form" id="courseCreateForm"
						...
						action="${pageContext.request.contextPath}/collegeinfo/course/create"
						method="post" >
						...
						<input type="hidden" class="form-control"  name="isOptional" value="false" >
						
						<div class="form-group">
							<label class="col-sm-2 control-label">专业ID</label>
							<div class="col-sm-10">
								<input class="form-control" value="${major.id}" name="majorId">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">选修</label>
							<div class="radio">
								<label >
									<input type="radio" name="isOptional" value="0" checked>否
								</label>
								<label >
									<input type="radio" name="isOptional" value="1">是
								</label>
							</div>
						</div>
	...
	<script type="text/javascript">
   	    	...
   	    	fields['id'].validators['notEmpty'] = {
   	    		...
   	    		if (!fields['majorId']) {
   	    		fields['majorId'] = {validators:{}};
   	    	}
   	    		fields['majorId'].validators['notEmpty'] = {
   	    		message: '专业ID不能为空'
   	    	}
