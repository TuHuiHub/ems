            ...
            <div class="col-lg-12">
				<div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                	<form role="form" id="emsTimeSlotUpdateForm" class="form-horizontal" 
							action="${pageContext.request.contextPath}/ems/timeSlot/update"
							method="post" enctype="multipart/form-data">
			                    ...
			                    <div class="col-sm-10">
			                    	<input class="form-control" placeholder="请输入timeslot" name="timeslot" value="${formData.timeslot}">
			                    </div>
			                </div>
			                			                			                			                <div class="form-group">
								<label class="col-sm-2 control-label">teachers</label>
								<div class="input-group">
									<input type="hidden" name="teachersJobNo" 
										value="${formData.teachersJobNo}">
		                            <input type="text" class="form-control" name="teachersName" readonly 
								...
								<div class="input-group">
									<input type="hidden" name="classRoomsId" 
										value="${formData.classRoomsId}">
		                            <input type="text" class="form-control" name="classRoomsRoomName" readonly 
		                            	value="${formData.classRoomsRoomName}">
		                            <span class="input-group-btn" wo:url="ems/classRoom/selector">
		                                <button class="btn btn-default" type="button"><i class="fa fa-search"></i>
		                                </button>
		                            </span>
	                            </div>
	   	    ...
	   	    $(document).ready(function () {
	   	    	...
	   	    	fields['id'].validators['notEmpty'] = {
	   	    		...
	   	    		fields['timeslot'] = {validators:{}};
	   	    		   	    		   	  		...
	   	    		   	    		   	  		// 将验证规则应用到表单的字段中
	   			$('#emsTimeSlotUpdateForm').bootstrapValidator({
		            // 默认错误消息
	   				message: '输入值不合法',
	   				// 设置验证成功或者失败的图标
		            feedbackIcons: {
		            ...
		            fields: fields
	   	  		...
	   	  		// 关联对象选择器按钮点击事件
	   	    	$('#emsTimeSlotUpdateForm .input-group-btn').click (function () {
