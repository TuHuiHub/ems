            ...
            <div class="col-lg-12">
				<div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                	<form role="form" id="emsClazzUpdateForm" class="form-horizontal" 
							action="${pageContext.request.contextPath}/ems/clazz/update"
							method="post" enctype="multipart/form-data">
			                    ...
			                    <div class="col-sm-10">
			                    	<input class="form-control" placeholder="请输入clazzName" name="clazzName" value="${formData.clazzName}">
			                    </div>
			                </div>
			                			                			                			                <div class="form-group">
	   	    ...
	   	    $(document).ready(function () {
	   	    	...
	   	    	fields['id'].validators['notEmpty'] = {
	   	    		...
	   	    		fields['clazzName'] = {validators:{}};
	   	    		   	    		   	  		...
	   	    		   	    		   	  		// 将验证规则应用到表单的字段中
	   			$('#emsClazzUpdateForm').bootstrapValidator({
		            // 默认错误消息
	   				message: '输入值不合法',
	   				// 设置验证成功或者失败的图标
		            feedbackIcons: {
		            ...
		            fields: fields
	   	  		...
	   	  		// 关联对象选择器按钮点击事件
	   	    	$('#emsClazzUpdateForm .input-group-btn').click (function () {
