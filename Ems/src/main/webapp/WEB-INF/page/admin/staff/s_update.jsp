	                	...
	                	<form role="form" id="studentUserUpdateForm" class="form-horizontal" 
						 ...
						 <div class="form-group">
								...
								<div class="input-group">
		                            ...
		                            <input type="text" class="form-control" name="majorName" value="${formData.majorName}" readonly>
            ...
            <script type="text/javascript">
	   	    ...
	   	    $(document).ready(function () {
	   	    	...
	   	    	$('#studentUserUpdateForm .input-group-btn').click (function () {
		        	...
		        	if (idField == 'majorId') {// 
		        		loadOpts.params = $('#studentUserUpdateForm input[name=collegeId]').val();
		        	}
				...
				window.selectstudentProject = function () {
					$('#studentUserUpdateForm input[name=majorId]').val('');
					$('#studentUserUpdateForm input[name=majorName]').val('');
				}
