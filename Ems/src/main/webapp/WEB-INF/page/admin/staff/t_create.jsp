            ...
            <div class="col-lg-12">
				<div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                	<form role="form" id="teacherUserCreateForm" class="form-horizontal" 
							action="${pageContext.request.contextPath}/staff/teacher/create"
						 ...
						 <div class="form-group">
			                    ...
			                    <div class="col-sm-10">
			                    	<input class="form-control" placeholder="请输入出生日期" name="birthday">
			                    </div>
			                </div>
						<div class="form-group">
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="col-sm-10">
			                    	<input class="form-control" placeholder="请输入学历" name="degree">
			                    </div>
			                </div>
			                <div class="form-group">
			                    <label class="col-sm-2 control-label">头衔</label>
			                    <div class="col-sm-10">
			                    	<input class="form-control" placeholder="请输入教学头衔" name="title">
			                    </div>
			                </div>
            ...
            <script type="text/javascript">
	   	    $(document).ready(function () {
	   	    	...
	   	    	fields['id'].validators['notEmpty'] = {
	   	  		...
	   	  		// 将验证规则应用到表单的字段中
	   			$('#teacherUserCreateForm').bootstrapValidator({
		            // 默认错误消息
	   				message: '输入值不合法',
	   				// 设置验证成功或者失败的图标
		            feedbackIcons: {
	   	    	...
	   	    	// 关联对象选择器按钮点击事件
	   	    	$('#teacherUserCreateForm .input-group-btn').click (function () {
