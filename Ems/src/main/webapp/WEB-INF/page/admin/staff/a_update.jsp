<%@page import="com.dream.ems.dto.AdminDto"%>
...
<%
	...
	AdminDto dto =  (AdminDto)request.getAttribute ("formData");
%>
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">修改管理员用户</div>
				<div class="panel-body">
					<form role="form" id="adminUserUpdateForm" class="form-horizontal"
						action="${pageContext.request.contextPath}/staff/admin/update"
						method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label class="col-sm-2 control-label">工号</label>
							<div class="col-sm-10">
								<input class="form-control" name="jobNo" readonly
		...
		$(document)
				.ready(
						function() {
							...
							// 关联对象选择器按钮点击事件
							$('#bsysUserUpdateForm .input-group-btn')
									.click(
											function() {
