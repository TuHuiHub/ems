            ...
            <div class="col-lg-12">
				<div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                	<form role="form" id="bsysDictionaryUpdateForm" class="form-horizontal" 
							action="${pageContext.request.contextPath}/bsys/dictionary/update"
							method="post" enctype="multipart/form-data">
			                    ...
			                    <div class="col-sm-10">
			                    	<input class="form-control" placeholder="请输入类型" name="dicType" value="${formData.dicType}">
			                    </div>
			                </div>
			                			                <div class="form-group">
			                    <label class="col-sm-2 control-label">值</label>
			                    <div class="col-sm-10">
			                    	<input class="form-control" placeholder="请输入值" name="val" value="${formData.val}">
			                    </div>
			                </div>
			                			                <div class="form-group">
			                    <label class="col-sm-2 control-label">键</label>
			                    <div class="col-sm-10">
			                    	<input class="form-control" placeholder="请输入键" name="name" value="${formData.name}">
			                    </div>
			                </div>
			                			                <div class="form-group">
			                    ...
			                    <div class="col-sm-10">
			                    	<input class="form-control" placeholder="请输入参数" name="params" value="${formData.params}">
			                    </div>
			                </div>
			                			                			                			                <div class="form-group">
	   	    ...
	   	    $(document).ready(function () {
	   	    	...
	   	    	fields['id'].validators['notEmpty'] = {
	   	    		...
	   	    		fields['params'] = {validators:{}};
	   	    		   	    		   	  		...
	   	    		   	    		   	  		// 将验证规则应用到表单的字段中
	   			$('#bsysDictionaryUpdateForm').bootstrapValidator({
		            // 默认错误消息
	   				message: '输入值不合法',
	   				// 设置验证成功或者失败的图标
		            feedbackIcons: {
		            ...
		            fields: fields
	   	  		...
	   	  		// 关联对象选择器按钮点击事件
	   	    	$('#bsysDictionaryUpdateForm .input-group-btn').click (function () {
	            	...
	            	$('#bsysDictionaryDialog').load ('${pageContext.request.contextPath}/' + $(this).attr('wo:url'), {
	            		formId : 'bsysDictionaryUpdateForm',
	            		idField : idField,
	            		nameField : nameField,
