	...
	pageEncoding="UTF-8"%>
		...
		<div class="modal-content">
			<div class="modal-header">
		        ...
		        <h4 class="modal-title" id="bsysRoleSelectorModalLabel">选择角色</h4>
		    </div>
            <!-- /.row -->
            <div class="modal-body">
                <table width="100%" class="table table-striped table-bordered table-hover" id="bsysRoleSelectorTable">
                    <thead>
                        <tr>
                            <th>ID</th>
                                                        <th>名称</th>
            ...
            $(document).ready(function() {
            	...
            	var tableId = 'bsysRoleSelectorTable';
            	var cols = [];
                ...
                var table = $('#' + tableId).DataTable({
                    ...
                    "rowId" : 'id',// 设置列为id
                    "ajax": {
                        "url": "${pageContext.request.contextPath}/bsys/role/selector/list", // 请求列表数据的url
                        "type": "GET"
                    },
                ...
                $('#' + tableId + '_length').append (" <a class='btn btn-primary btn-sm' onclick='selectBsysRoleOK();'>确定</a> <a class='btn btn-primary btn-warning btn-sm' onclick='closeBsysRoleSelector();'>取消</a>");
                
                // 确定按钮点击事件
                window.selectBsysRoleOK = function () {
             	...
             	// 确定按钮点击事件
                window.closeBsysRoleSelector = function () {
                	$('#' + tableId).parents ('.modal').modal('hide');
                }
            });
