		...
		<div id="page-wrapper">
            ...
            <div class="col-lg-12">
				<div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                	<form role="form" id="bsysUserCreateForm" class="form-horizontal" 
							action="${pageContext.request.contextPath}/bsys/user/create"
							method="post" enctype="multipart/form-data">
			                    ...
			                    <div class="col-sm-10">
			                    	<input class="form-control" placeholder="请输入创建时间" name="createTime">
			                    </div>
			                </div>
			                			                <div class="form-group">
			                    <label class="col-sm-2 control-label">修改密码时间</label>
			                    <div class="col-sm-10">
			                    	<input class="form-control" placeholder="请输入修改密码时间" name="passwordTime">
			                    </div>
			                </div>
			                			                			                			                <div class="form-group">
            ...
            <script type="text/javascript">
	   	    $(document).ready(function () {
	   	    	...
	   	    	// 关联对象选择器按钮点击事件
	   	    	$('#bsysUserCreateForm .input-group-btn').click (function () {
