 ...
 */
@Controller
@RequestMapping("/bsys/dictionary")
...
public class DictionaryController {
	...
	@RequestMapping("/list")
	@ResponseBody
	public WoDataTable<DictionaryDto> getDataTable(Integer draw, Long start, Long length,
			@RequestParam("search[value]") String searchContent, @RequestParam("order[0][dir]") String dir) {
		WoPage<DictionaryDto> page = dictionaryService.getPageData(start, length, searchContent, dir);
		return new WoDataTable<DictionaryDto>(page, draw);
	}
	...
	public String create (Map<String, Object> map) {
		map.put("url", "dictionary/create.jsp");
		return "main";
	}
	 ...
	 */
	@PostMapping("/create")
	public String create (DictionaryDto dto, Map<String, Object> map) {
	...
	public String update (String id, Map<String, Object> map) {
		DictionaryDto dto = dictionaryService.getById (id);
		map.put("url", "dictionary/update.jsp");
	 ...
	 */
	@PostMapping("/update")
	public String update (DictionaryDto dto, Map<String, Object> map) {
	...
	public WoResultCode delete (String[] id) {
		...
		return WoResultCode.getSuccessCode().setMsg("删除数据字典成功!");
	}
	...
	@ResponseBody
	public WoDataTable<DictionaryDto> getSelectorDataTable(Integer draw, Long start, Long length,
			@RequestParam("search[value]") String searchContent, @RequestParam("order[0][dir]") String dir) {
		WoPage<DictionaryDto> page = dictionaryService.getPageData(start, length, searchContent, dir);
		return new WoDataTable<DictionaryDto>(page, draw);
	}
